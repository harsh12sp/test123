...
{
    public class HanaCreateCustomerLoyaltyRequest
    {

        [JsonProperty("bmc_id")] public string BenjaminMooreCustomerId { get; set; }

        [JsonProperty("retailer_id")] public string RetailerId { get; set; }

        [JsonProperty("business_name")] public string BusinessName { get; set; }

        [JsonProperty("business_email_id")] public string BusinessEmailAddress { get; set; }

        [JsonProperty("loyalty_email_id")] public string LoyaltyEmailAddress { get; set; }
        ...
        [JsonProperty("business_type")] public string BusinessType { get; set; }

        [JsonProperty("outlet")] public string Outlet { get; set; }
